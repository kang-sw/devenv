...
// DeleteOverride implements wsconfig.SessionWriter.
func (a sessionConfigAdapter) DeleteOverride(sessionKey, itemKey string) error {
	return a.s.deleteOverride(sessionKey, itemKey)
}
