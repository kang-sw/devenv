...
pub fn build_router(state: AppState) -> Router {
    ...
    let protected = Router::new()
        ...
        .route(
            "/api/dashboard/servers/{server_id}/workspaces/{workspace_id}",
            delete(server_scoped_remove_workspace),
        )
        .route(
            "/api/dashboard/servers/{server_id}/workspaces/{workspace_id}/git-worktree-add/options",
            get(server_scoped_git_worktree_add_options),
        )
        .route(
            "/api/dashboard/servers/{server_id}/workspaces/{workspace_id}/git-worktree-add/preview",
            post(server_scoped_git_worktree_add_preview),
        )
        .route(
            "/api/dashboard/servers/{server_id}/workspaces/{workspace_id}/git-worktree-add",
            post(server_scoped_git_worktree_add_submit),
        )
        .route(
            "/api/dashboard/servers/{server_id}/work-roots/{work_root_id}/activity",
            get(server_scoped_work_root_activity),
        )
        .route(
            "/api/dashboard/servers/{server_id}/work-roots/{work_root_id}/activity/items/{activity_id}/transcript",
            get(server_scoped_work_root_activity_transcript),
        )
        .route(
            "/api/dashboard/servers/{server_id}/work-roots/{work_root_id}/activity/events",
            get(server_scoped_work_root_activity_events),
        )
        .route(
            "/api/dashboard/servers/{server_id}/work-roots/{work_root_id}/git/status",
            get(server_scoped_git_status),
        )
        .route(
            "/api/dashboard/servers/{server_id}/work-roots/{work_root_id}/git/branches",
            get(server_scoped_git_branches).post(server_scoped_git_branches),
        )
        .route(
            "/api/dashboard/servers/{server_id}/work-roots/{work_root_id}/git/switch-branch",
            post(server_scoped_git_switch_branch),
        )
        .route(
            "/api/dashboard/servers/{server_id}/work-roots/{work_root_id}/git/fetch",
            post(server_scoped_git_fetch),
        )
        .route(
            "/api/dashboard/servers/{server_id}/work-roots/{work_root_id}/git/push",
