...
const remoteFetched = await fetchRootPicker("C:/Remote Root", "server remote/1");
assertEqual(
  capturedUrl,
  "/api/dashboard/servers/server%20remote%2F1/root-picker?path=C%3A%2FRemote+Root",
...
await createRootPickerDirectory("C:/Remote Root", "alpha", "server remote/1");
assertEqual(
  capturedUrl,
  "/api/dashboard/servers/server%20remote%2F1/root-picker/directories",
...
await pinRootPickerDirectory("C:/Remote Root/alpha", "server remote/1");
assertEqual(
  capturedUrl,
  "/api/dashboard/servers/server%20remote%2F1/root-picker/pins",
...
await unpinRootPickerDirectory("C:/Remote Root/alpha", "server remote/1");
assertEqual(
  capturedUrl,
  "/api/dashboard/servers/server%20remote%2F1/root-picker/pins",
