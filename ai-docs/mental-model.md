...
| Dashboard daemon, browser UI, owner auth, core resource vocabulary, host-control boundary | `spec/ws-web-dashboard/index.md` | `mental-model/ws-web-dashboard.md` |
...
| ws-web-dashboard | `mental-model/ws-web-dashboard.md` | Personal ws dashboard daemon, owner-auth boundary, UI serving, core resource vocabulary, and host-control separation |
