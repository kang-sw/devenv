...
| Workflow skills, routing, sprint/review/proceed behavior | `spec/workflow-skills.md` | `mental-model/workflow-skills.md`, `manuals/wsflow-mirroring.md` when wsflow mirrors may change |
