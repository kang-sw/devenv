...
| Named agents, worktree-scoped registry metadata, subqueries, backend behavior | `spec/named-agent-runtime.md` | `mental-model/named-agent-runtime.md`, `ref/ws-agent-runtime.md` |
...
| named-agent-runtime | `mental-model/named-agent-runtime.md` | Worktree-scoped SQLite agent registry metadata, file-backed payloads, async calls, subqueries, Codex backend handling |
