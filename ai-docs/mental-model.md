...
| Dashboard daemon, browser UI, owner auth, resource view-model API/fixtures, host-control boundary | `spec/ws-web-dashboard/index.md` | `mental-model/ws-web-dashboard.md` |
...
| ws-web-dashboard | `mental-model/ws-web-dashboard.md` | Personal ws dashboard daemon, owner-auth boundary, UI serving, resource view-model API/fixtures, and host-control separation |
