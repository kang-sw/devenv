...
**Scope:** `claude-plugin/skills/`, `claude-plugin/agents/`, `claude-plugin/infra/` (`.md` files only). Excludes `claude-plugin/CLAUDE.home.md` and `claude-plugin/bin/`.
...
**Scope:** `claude-plugin/skills/`, `claude-plugin/agents/`, and `claude-plugin/bin/`.
