...
7. Route deeper semantic work through the owning workflow: procedures to
   `ai-docs/manuals/`, ticket readiness/status wording to `ws:lead-ticket`, and
   ambiguous direction to `ws:lead-discuss`.
