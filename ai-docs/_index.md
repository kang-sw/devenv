...
Active plugin package: `agents-plugin/` (`ws@0.29.3`).
Agentless derivative package: `agents-plugin-wsflow/` (`wsflow@0.29.3`).
...
| `260525-feat-ws-dashboard-server-scoped-operation-forwarding` | ready | Make root picker, workRoot, file, Activity, Git, and terminal operations transparent across linked servers |
...
6 remote terminal HTTP lifecycle after Activity, Git, workspace, and Git
worktree-add forwarding.
