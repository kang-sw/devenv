...
| `260508-chore-skill-description-attention-policy` | ready | Tune skill descriptions by entry-point strength and explicit rule persistence intent |
...
`260508-chore-skill-description-attention-policy` - strengthen top-level skill trigger descriptions, keep derived stages lighter, and require explicit persistence intent for rule storage.
