...
| `260517-bug-ws-dashboard-dockview-dynamic-groups` | todo | Make Dockview split drops create durable dynamic workbench groups with constrained automatic placement |
