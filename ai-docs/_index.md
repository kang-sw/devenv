...
| `260524-feat-ws-dashboard-icon-chrome-refinement` | ready | Refine dashboard icon chrome density, state treatment, hover reveal styling, and readable topbar/menu labels |
...
- `260524-feat-ws-dashboard-icon-chrome-refinement` - refine icon-first
  dashboard chrome density, state treatment, hover reveal styling, and readable
  topbar/menu labels.
