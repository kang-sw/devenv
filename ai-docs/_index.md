...
| `260518-feat-contextual-mental-model-update` | todo | Improve mental-model-updater context via commit `### Mental Model Notes` annotations and brief self-detection |
