...
| `260523-bug-agents-root-schema-visible` | todo | Remove visible `root` parameters from public/generated `agents.*` schemas while preserving `ws.setup` as the session-root surface |
