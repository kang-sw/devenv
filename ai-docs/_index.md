...
| `260516-feat-ws-web-instance-event-stream` | ready | Define the authenticated instance event envelope and fixture-backed stream scaffold |
...
`260516-feat-ws-web-instance-event-stream` - define the authenticated instance event envelope and fixture-backed stream scaffold.
