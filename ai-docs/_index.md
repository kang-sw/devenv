...
| `260518-feat-ws-dashboard-activity-console-ui` | ready | Build the reusable route-backed Activity Ribbon and Transcript Block UI shell |
...
- `260518-feat-ws-dashboard-activity-console-ui` - Route-backed Activity
  Ribbon and Transcript Block UI shell inside the WorkRoot Activity pane;
  implements `{#260521-ws-dashboard-activity-console-ui-shell}`.
