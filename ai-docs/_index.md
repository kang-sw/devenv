...
| `260513-feat-harness-local-agent-tier-config` | ready | Make config.agents_tier update the explicit or detected harness alias |
...
`260513-feat-harness-local-agent-tier-config` - make agent tier config update the explicit or detected harness alias before implementation.
