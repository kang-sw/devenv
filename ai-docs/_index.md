...
| `260525-feat-ws-dashboard-endpoint-linked-server-add` | ready | Add endpoint-first linked server registration and browser add-server modal |
...
- `260525-feat-ws-dashboard-endpoint-linked-server-add` - implement endpoint-first linked server registration and the browser add-server modal on top of the completed gateway substrate.
