...
Active plugin package: `agents-plugin/` (`ws@0.29.2`).
Agentless derivative package: `agents-plugin-wsflow/` (`wsflow@0.29.2`).
...
| `260525-bug-subquery-result-actor-scope` | idea | Investigate subquery result keys that are not retrievable in the current actor scope after explicit-root start |
...
| `260525-bug-actor-gate-verbose-setup-guidance` | idea | Trim root-omitted agent setup errors so tool output does not duplicate workflow-manual briefing |
