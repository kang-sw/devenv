...
| `260615-refactor-native-explore-dispatch-skill-guidance` | ready | Move scoped exploration guidance from the generic `explore` render brief to direct host-native exploration-worker dispatch |
...
- `260615-refactor-native-explore-dispatch-skill-guidance` - ready follow-up
  ...
  long-term status of the generic `explore` playbook.
