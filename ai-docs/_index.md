...
| `260512-feat-llm-readable-mcp-output-defaults` | todo | Make read-only MCP tool defaults compact and LLM-readable with structured escape hatches where needed |
