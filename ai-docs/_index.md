...
| `260503-epic-ws-agent-workflow-stability` | todo | Live stabilization epic for named-agent workflow lifecycle, timeout, cancellation, diagnostics, and lead-context compression; Phase 1 complete |
...
`260503-epic-ws-agent-workflow-stability` — active runtime quality gate for `write-code`: Phase 1 lifecycle hardening is complete; next phase is lead-context compression around summaries, print/status/tail ergonomics, and review relay outputs
...
refresh. `260503-epic-ws-agent-workflow-stability` Phase 1 hardened async wait,
status, cancellation, and runtime diagnostics; Phase 2 should reduce lead
context usage by improving summaries and normal status/print/tail ergonomics.
