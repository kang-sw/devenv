...
| `260524-feat-ws-dashboard-icon-chrome-refinement` | todo | Refine dashboard icon chrome density, state treatment, hover reveal styling, and readable topbar/menu labels |
