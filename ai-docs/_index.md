...
| `260506-bug-ws-mcp-launcher-startup-delay` | todo | Reduce Python launcher compatibility preflight cost on Windows |
...
`260506-bug-ws-mcp-launcher-startup-delay` - implement Phases 1 and 2 first: avoid duplicate compatibility checks and add a hot-path compatibility stamp; Phase 3 single capability command remains larger follow-up scope.
