...
| `260517-bug-ws-dashboard-dockview-workbench-parity` | todo | Correct the dashboard workbench so Dockview is the visible layout owner while preserving file and terminal pane parity |
