...
| `260516-feat-ws-web-readonly-text-pane` | ready | Add read-only text file panes and file-open placement |
...
`260516-feat-ws-web-readonly-text-pane` - add authenticated read-only file preview APIs, workbench text panes, and file-open placement for the workRoot IO substrate.
