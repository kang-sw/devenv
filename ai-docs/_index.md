...
Active plugin package: `agents-plugin/` (`ws@0.24.0`).
...
| `260513-feat-proceed-phase-slice-routing` | todo | Add phase-sliced proceed routing and autonomous todo promotion |
| `260513-feat-ws-setup-root-session-api` | todo | Replace public root setup with a canonical ws.setup entrypoint |
