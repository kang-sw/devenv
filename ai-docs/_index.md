...
| `260516-bug-ws-web-dashboard-ui-acceptance-recovery` | ready | Recover dashboard workRoot UI acceptance with browser-level evidence before merging |
...
`260516-bug-ws-web-dashboard-ui-acceptance-recovery` - recover dashboard workRoot UI acceptance with daemon-served browser evidence before merging the workRoot IO implementation branch.
