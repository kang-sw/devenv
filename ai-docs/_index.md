...
| `260516-feat-ws-web-resource-view-model-contract` | ready | Define first visible dashboard resource APIs, workRoot vocabulary, mock provider, and golden fixtures |
...
`260516-feat-ws-web-resource-view-model-contract` - implement the first visible dashboard resource/view-model API contract, workRoot vocabulary, protected mock provider, and golden fixtures.
