...
| `260517-bug-ws-dashboard-dockview-dynamic-groups` | ready | Make Dockview split drops create durable dynamic workbench groups with constrained automatic placement |
...
- `260517-bug-ws-dashboard-dockview-dynamic-groups` - make Dockview split-drop
  previews durable by promoting created split groups into dashboard state;
  prerequisite for placement-sensitive tab polish.
