...
- `lead-implement` compacts only safe documentation-only branch-tip closeout suffixes before merge readiness; broad branch history cleanup, planning commits, source/review commits, and ambiguous suffixes are preserved and reported as skipped. {#260523-implement-doc-closeout-compaction}
