...
- `lead-verify-discussion` is a small explicit checkpoint for refreshing discussion premises and code-hygiene fit through `ws/subquery`; keep it callable and lightweight. {#260512-discussion-verification-skill}
