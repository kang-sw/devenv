...
- wsflow includes sprint as a branch container and routes source changes through `lead-implement`; current wsflow execution remains `lead-edit`-mediated while scoped subagents may help exploration, implementation, verification, audit, or review and the lead keeps integration, final judgment, and commits explicit. {#260513-wsflow-agentless-skill-surface} {#260513-wsflow-sprint-skill}
