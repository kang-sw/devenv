...
- `lead-is-finished-yet` is a small explicit checkpoint for separating user-blocking design questions from autonomous hygiene, implementation detail, ticket/spec capture gaps, and proceed readiness. {#260513-is-finished-yet-skill}
