...
- `lead-proceed` does not rejudge ticket decomposition; default execution is the first unfinished phase, `auto-slice` may group cohesive adjacent phases, and selected slices are hard downstream scope. {#260505-proceed-routing-pipeline}
