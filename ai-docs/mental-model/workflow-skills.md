...
- `lead-proceed` does not rejudge ticket decomposition; absent explicit phase names, it autonomously selects the broadest cohesive unfinished slice and treats selected slices as hard downstream scope. {#260505-proceed-routing-pipeline}
...
- `lead-write-ticket` treats cascade wording as related-ticket propagation: graph discovery first, epics board-level, child details in child tickets, and no implicit ready promotion. {#260516-write-ticket-related-ticket-propagation}
