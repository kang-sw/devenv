---
domain: doc-tooling
description: "Mental-model authoring toolchain: forge-mental-model, mental-model-updater, and add-rule — their contracts, coupling, forge authority, Domain Rules handling, and the commit-stamp checkpoint mechanism."
sources:
