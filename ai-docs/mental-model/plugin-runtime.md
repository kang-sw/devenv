...
- Runtime capability output is mode-sensitive only for explicit product modes such as hbsflow no-agent; tool-profile and allowed-tool filters remain ignored for the full ws launcher contract. {#260513-hbsflow-runtime-contract-mode}
