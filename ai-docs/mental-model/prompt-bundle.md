...
- `lead-write-skeleton` registers `skeleton-populator`; `skeleton-writer` remains a compatibility prompt name with the same contract-preserving populator boundary.
