...
Close the agent-row telemetry ticket using the q8 and q16 state-local owner evidence. Then run the consolidated persistent/deep Explore acceptance: simple settle and follow-up, deep child collection and synthesis, explicit stop/resume, full Pi restart and post-restart follow-up, retained role/model/effort, and exact deep-child launch environment.
