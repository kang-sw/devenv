...
- `260619-feat-ws-session-lineage-children` (ready, **Phases 1-2 landed**
  (`1f72fa3c` store+render lineage, drift-fix `95d56b26`; `12eb1bbe` ferrule
  `parent_session_key`); Phase 3 (`ws.session.children`) remaining — session-key
