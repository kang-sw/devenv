...
/**
 * Private per-launch transport for immutable fork metadata. Fork readiness no
 * longer travels through files: it is the stage-2 readiness message on the
 * parent-child control channel (`agent-channel.ts`).
 */
