...
import { createAgentFooterController, type AgentFooterComponent, type AgentFooterController } from "../src/agent-footer.ts";
import { registerAgentCostOwner } from "../src/agent-cost.ts";
