...
- Write the subject as the decision itself, self-describing and not a label; treat any secondary note or description field as optional detail that may not render and must never carry load-bearing content.
