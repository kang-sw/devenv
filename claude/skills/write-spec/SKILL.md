...
- Run `ws-spec-build-index` on the target file after every write or update.
...
2. If creating a new spec:
   ...
   c. Run `ws-spec-build-index` on the new file.
...
3. If updating an existing spec:
   ...
   e. Run `ws-spec-build-index` to regenerate the `features:` frontmatter field.
...
features:           # auto-generated by ws-spec-build-index; never edit manually
---
