...
- The `features:` frontmatter field is auto-generated by `build-index.py` — never edit manually.
- Run `build-index.py` on the target file after every write or update.
...
2. If creating a new spec:
   ...
   c. Run `build-index.py` on the new file.
...
3. If updating an existing spec:
   ...
   c. Run `build-index.py` to regenerate frontmatter.
...
features:           # ← auto-generated by build-index.py; never edit manually
---
