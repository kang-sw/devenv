...
- Invoke the `spec-updater` agent (`claude/agents/spec-updater.md`) to strip `🚧` markers from any planned features whose implementation has since landed in commit history.
