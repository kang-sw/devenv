...
- Run `ws-generate-spec-stem <descriptive-slug>` to obtain a collision-free stem before inserting.
...
Run `ws-spec-build-index` (no arguments) after every spec write or update. It scans the full
