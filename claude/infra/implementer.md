...
5. **Explore when needed**: Use Grep/Glob/Read for focused queries. For broader or external lookups, use `subquery "<question>"` (haiku) or `subquery --deep-research "<question>"` (sonnet).
